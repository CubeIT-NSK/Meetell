    ...
    <div ref={tripRef} className={`route_info_slide_in ${customClass}`}>
      <div className="route_head">
        ...
        <div className="route_info_blocks">
          <div className="route_info_block route_info_range">
            {selectedRoute.distance}{" "}
            <span className="route_info_small">км.</span>
          </div>
          ...
          <div className="route_info_block route_info_time">
            {selectedRoute.time_sp}{" "}
            <span className="route_info_small">мин.</span>
          </div>
        </div>
      </div>
      <div className="yandex_map">
        <a href="https://yandex.ru/maps/?um=constructor%3A6e3dca864c766510bf6e3faf979864e2734079597aae16e2ce7cadd8f0ffd821&amp;source=constructorStatic">
          <img
            src="https://api-maps.yandex.ru/services/constructor/1.0/static/?um=constructor%3A6e3dca864c766510bf6e3faf979864e2734079597aae16e2ce7cadd8f0ffd821&amp;width=500&amp;height=400&amp;lang=ru_RU"
            alt=""
          />
        </a>
      </div>
      <div className="route_bottom">
        ...
        <div className="footer_nav">
          {registr && (
            <div className="route_button_chat">
              <button
                ...
                onClick={() => handleJoinButton(selectedRoute)}
              >
                Перейти в чат
              </button>
            </div>
          ...
          {!registr && (
            <div className="route_button_chat">
              <button className="button_registr" onClick={handleRegistrButton}>
                Заполнить профиль
              </button>
              <p className="route_register_text">
                Заполните небольшую анкету чтобы мы могли предлагать вам только
                подходящие маршруты.
              </p>
            </div>
          )}
